...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7]" style={{ fontFamily: 'var(--font-body)' }}>
      ...
      <section id="how-it-works" className="py-20 border-t border-[#E4E7E1]">
        <div className="max-w-5xl mx-auto px-7">
          <div className="max-w-xl mb-11">
      ...
      <section className="py-20 border-t border-[#E4E7E1]">
        <div className="max-w-5xl mx-auto px-7 text-center">
          ...
          <h2 className="text-[28px] sm:text-4xl font-bold leading-tight text-[#13221D]" style={displayFont}>Start free. Upgrade when you outgrow it.</h2>
          <p className="mt-3.5 text-[17px] text-[#5C6E65] max-w-md mx-auto">No trial countdown, no credit card to start.</p>
          <Link href="/pricing" className="inline-flex mt-7 text-base font-bold text-white bg-[#E64A12] hover:bg-[#13221D] transition-colors rounded-lg px-7 py-3.5">See full pricing →</Link>
        </div>
      </section>

      <section id="faq" className="py-20 border-t border-[#E4E7E1]">
        <div className="max-w-5xl mx-auto px-7">
          <div className="max-w-xl mb-8">
        ...
        <div className="max-w-5xl mx-auto px-7">
          <div className="grid sm:grid-cols-[1.4fr_1fr_1fr_1fr] gap-9 pb-11">
            ...
            <div>
              ...
              <a href="#specsheet" className="block text-sm mb-2.5 text-[#13221D] hover:text-[#E64A12]">Features</a>
              <Link href="/pricing" className="block text-sm mb-2.5 text-[#13221D] hover:text-[#E64A12]">Pricing</Link>
            </div>
            <div>
              <h4 className="text-xs uppercase tracking-wide text-[#5C6E65] mb-4" style={monoFont}>Resources</h4>
              <a href="#faq" className="block text-sm mb-2.5 text-[#13221D] hover:text-[#E64A12]">FAQ</a>
            </div>
            <div>
<h4 className="text-xs uppercase tracking-wide text-[#5C6E65] mb-4" style={monoFont}>Legal</h4>
<Link href="/privacy" className="block text-sm mb-2.5 text-[#13221D] hover:text-[#E64A12]">Privacy</Link>
<Link href="/terms" className="block text-sm mb-2.5 text-[#13221D] hover:text-[#E64A12]">Terms</Link>
<Link href="/refund" className="block text-sm mb-2.5 text-[#13221D] hover:text-[#E64A12]">Refund Policy</Link>
            </div>
          </div>
