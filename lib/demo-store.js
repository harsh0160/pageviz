...
const createInitialState = () => ({
  user: { name: 'Alex Rivera', email: 'alex@studionorth.design', plan: 'pro' },
  range: '7',
  compare: true,
  digest: false,
  heartbeat: 0,
  ...
  sites: [
    {
      id: 'studio-north', name: 'Studio North', domain: 'studionorth.design', monogram: 'N', color: 'forest',
    ...
    {
      id: 'bloom-journal', name: 'Bloom Journal', domain: 'bloomjournal.co', monogram: 'b', color: 'pink',
    ...
    {
      id: 'fieldnotes', name: 'Fieldnotes', domain: 'fieldnotes.blog', monogram: 'f.', color: 'sand',
    ...
    {
      id: 'little-sundays', name: 'Little Sundays', domain: 'littlesundays.co', monogram: 's', color: 'lavender',
