...
// `pageviews` is a monthly allowance across all of a workspace's sites. It is shown and
// measured, nothing is blocked by it: going over only brings up a note in the dashboard.

export const PLANS = {
  free: {
    name: 'Free', price: 0, sites: 1, pageviews: 10000, history: '7 days', maxDays: 7,
    description: 'A little insight goes a long way.',
    features: ['1 website', '10,000 pageviews a month', '7-day data history', 'Simple, cookieless analytics', 'All the essentials, no noise'],
  },
  pro: {
    name: 'Pro', price: 9, sites: 10, pageviews: 100000, history: '1 year', maxDays: 365,
    ...
    features: ['10 websites', '100,000 pageviews a month', '1-year data history', 'Real-time “reading now” count', 'Custom events & goals', 'CSV exports', 'Password-protected share links'],
  },
  business: {
    name: 'Max', price: 22, sites: 30, pageviews: 500000, history: 'Forever', maxDays: Infinity,
    description: 'The whole picture, all together.',
    features: ['30 websites', '500,000 pageviews a month', 'Keep your data forever', 'Everything in Pro', 'Combined multi-site dashboard'],
  },
}
